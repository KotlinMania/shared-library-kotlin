...
This file is the quick-reference operating contract for shared-library-kotlin. The longer
...
shared-library-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`shared_library`](https://crates.io/crates/shared_library). Upstream Rust is the behavioral oracle while the
