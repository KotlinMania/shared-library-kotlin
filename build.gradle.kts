...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "SharedLibrary"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SharedLibrary"; xcf.add(this) }
    }
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.sharedlibrary"
    }

    android {
        namespace = "io.github.kotlinmania.sharedlibrary"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "shared-library-kotlin", version.toString())

    pom {
        name.set("shared-library-kotlin")
        description.set("Kotlin Multiplatform port of tomaka/shared_library - Easily bind to and load shared libraries")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/shared-library-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/shared-library-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/shared-library-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/shared-library-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSharedLibraryXCFramework",
    "assembleSharedLibraryDebugXCFramework",
    "assembleSharedLibraryReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseIosFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugMacosFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseMacosFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugTvosFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseTvosFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugWatchosFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseWatchosFatFrameworkForSharedLibraryXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSharedLibraryXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSharedLibraryXCFramework",
